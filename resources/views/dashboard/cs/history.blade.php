...
@section('title', 'Riwayat Servis - CS')
@section('page_title', 'Riwayat Servis CS')
...
<div class="dash-card" style="margin-bottom: 20px; padding: 16px;">
    <form method="GET" action="{{ route('dashboard.cs.history') }}" style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap;">
        {{-- Search Input --}}
        <div style="flex: 1; min-width: 240px; position: relative;">
            <input type="text" name="search" value="{{ request('search') }}"
                   placeholder="Cari nama customer, no. tiket, no. telp, unit..."
                   class="form-control"
        ...
        <a href="{{ route('dashboard.cs.history') }}" class="btn btn-outline" style="height: 40px; padding: 0 14px; font-size: 0.85rem; display: inline-flex; align-items: center;">
            Reset
        </a>
        @endif
    </form>
    ...
    <div class="dash-card-body" style="padding: 0;">
        ...
        <div class="table-wrap">
            <table>
                <thead>
                    <tr>
                        <th style="padding: 10px 14px; font-size: 0.72rem;">No. Tiket / Antrian</th>
                        <th style="padding: 10px 14px; font-size: 0.72rem;">Customer</th>
                        <th style="padding: 10px 14px; font-size: 0.72rem;">Unit Perangkat</th>
                        <th style="padding: 10px 14px; font-size: 0.72rem;">Teknisi PJ</th>
                        <th style="padding: 10px 14px; font-size: 0.72rem;">Status</th>
                        <th style="padding: 10px 14px; font-size: 0.72rem;">Tanggal Selesai</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding: 10px 14px; font-size:0.85rem; color:var(--text-secondary);">
                        ...
                        <td style="padding: 10px 14px; font-size:0.78rem; color:var(--text-muted);">{{ $ticket->updated_at->format('d M Y H:i') }}</td>
