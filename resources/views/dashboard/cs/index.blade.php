                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid var(--border-light);">
                            ...
                            <td style="padding: 8px 14px;">
                                ...
                                @php
                                    $regSnCs = $ticket->laptopKit?->axioo_serial_number ?: ($ticket->customer?->laptopKits?->where('is_regular', true)->first()?->axioo_serial_number);
                                @endphp
                                @if($regSnCs)
                                    <div style="font-size:0.68rem; font-family:monospace; color:#0284c7; font-weight:700; margin-top:2px;">SN: {{ $regSnCs }}</div>
                                @endif
                            </td>
